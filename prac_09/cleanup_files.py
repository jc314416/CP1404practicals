...
def get_fixed_filename(filename):
    ...
    for character in filename:
        if preceding_character == "" or preceding_character == " ":
            character = character.upper()
        if preceding_character.islower() and character.isupper():
            new_filename += "_"
        # TODO ask if space needed between number and character
        # if preceding_character.isdigit() and character.isalpha():
        #     new_filename += "_"
        preceding_character = character
